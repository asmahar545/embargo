...
class __TwigTemplate_86363e1b6e6d966601e7d3cdb028e9714463eaba8d2ca63bae0a78210fe3fceb extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 27];
        $filters = ["clean_class" => 29, "join" => 39, "escape" => 43, "raw" => 45, "safe_join" => 46];
        $functions = [];

        try {
            $this->sandbox->checkSecurity(
                ['set'],
                ['clean_class', 'join', 'escape', 'raw', 'safe_join'],
                []
            );
