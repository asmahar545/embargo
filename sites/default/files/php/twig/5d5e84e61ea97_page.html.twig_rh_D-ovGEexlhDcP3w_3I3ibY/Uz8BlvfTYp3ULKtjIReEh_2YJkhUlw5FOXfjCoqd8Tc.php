    ...
    ";
        ...
        <nav  style=\"min-height: 68px;\"class=\"navbar navbar-light bg-light\">
            ...
            <ul class=\"nav navbar-nav col-lg-8 \">
                ...
                <lsi><a onmouseover=\"this.style.background = '#0d5178';
                        this.style.color = '#FFFFFF';\"  onmouseout=\"this.style.background = '';
